...
// //voice input 
// export const profileInfoStyles = {
//   container: "p-8 bg-white shadow-xl rounded-2xl",
//   heading: "text-3xl font-extrabold text-gray-900 mb-2 border-b pb-4 border-rose-100",
//   textarea: "w-full p-4 bg-white border border-rose-200 rounded-xl focus:border-rose-400 focus:ring-4 focus:ring-rose-50 transition-all resize-none outline-none",
// };

// export const buttonStyles = {
//   next: "bg-rose-500 hover:bg-rose-600 text-white font-bold py-3 px-6 rounded-full shadow-lg transition duration-300 ease-in-out transform hover:scale-105",
//   back: "bg-gray-200 hover:bg-gray-300 text-gray-800 font-bold py-3 px-6 rounded-full transition duration-300 ease-in-out",
// };
