                    ...
                    <div className="flex flex-wrap gap-3 text-sm">
                        {contactInfo.email && (
                            <div className="flex items-center">
                                <span className="text-current"><LuMail className="mr-1" /></span>
                        ...
                        {contactInfo.phone && (
                            <div className="flex items-center">
                                <span className="text-current"><LuPhone className="mr-1" /></span>
                ...
                <div className="flex flex-col items-end text-sm">
                    {contactInfo.linkedin && (
                        <div className="flex items-center mb-1">
                            <span className="text-current"><RiLinkedinLine className="mr-1" /></span>
                    ...
                    {contactInfo.github && (
                        <div className="flex items-center mb-1">
                            <span className="text-current"><LuGithub className="mr-1" /></span>
                    ...
                    {contactInfo.website && (
                        <div className="flex items-center">
                            <span className="text-current"><LuGlobe className="mr-1" /></span>
