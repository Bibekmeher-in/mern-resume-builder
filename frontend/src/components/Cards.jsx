...
import { Edit, Trash2, Award, TrendingUp, Zap, Check, Clock } from "lucide-react";
      ...
      ${isSelected
        ...
        >
            {ThumbnailImg ? (
                ...
                <div className="w-full h-[200px] flex items-center flex-col justify-center bg-gradient-to-br from-violet-50 via-violet-100 to-fuchsia-50">
